...
{
    public partial class TournamentEditionViewModel : ObservableObject
    {
        ...
        public TournamentEditionViewModel(TournamentDto existingTournament,
            IService<TournamentDto> tournamentService,
            MainViewModel mainViewModel) 
        {
            _tournamentService = tournamentService;
            _mainViewModel = mainViewModel;
            _originalId = existingTournament.Id;
        ...
        private async Task SaveTournament()
        {
            ...
            try
            {
                ...
                MessageBox.Show("Турнир успешно обновлен!", "Информация", MessageBoxButton.OK, MessageBoxImage.Information);
